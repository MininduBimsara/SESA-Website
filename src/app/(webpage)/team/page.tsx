...
const currentBoard: TeamMember[] = [
    ...
    {
        name: 'Yasiru Upananda',
        position: 'Vice President',
        image: '/placeholder-user.jpg'
    },
    {
        name: 'Sachini Weerakkody',
        position: 'Secretary',
        image: '/placeholder-user.jpg'
    },
    {
        name: 'Chathura Hapukotuwa',
...
const previousBoard: TeamMember[] = [
    ...
    {
        name: 'Ramitha Iddamalgoda',
        position: 'Junior Treasurer',
        image: '/placeholder-user.jpg'
    },
    {
        name: 'Nadun DannanJaya',
        position: 'Editor',
        image: '/placeholder-user.jpg'
    },
    {
                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                            Meet Our Executive Board 2025/26
                        </h1>
            ...
            <section className="py-16 px-4 md:px-8 lg:px-16 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    <motion.div
                        ...
                        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8"
                    >
                        {previousBoard.map((member, index) => (
                            <motion.div
                                key={index}
                                variants={itemVariants}
                                className="group"
